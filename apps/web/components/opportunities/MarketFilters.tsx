...
import { Input, Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@/components/ui/primitives";
...
export const MarketFilters: React.FC<{
  ...
  const closeAll = () => { setRiskOpen(false); setSortOpen(false); };
