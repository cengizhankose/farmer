...
const ConnectButton = () => {
  ...
  return (
    <Button
      ...
      disabled={connecting}
      className="gap-2 bg-zinc-900 text-white hover:bg-black"
    >
    ...
    <header className="site-header sticky top-0 z-40 w-full border-b border-zinc-200/60 bg-white/70 backdrop-blur-2xl">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-3">
        ...
        <nav className="flex items-center gap-6 text-sm">
          ...
          <Link href="/portfolio" className="text-zinc-600 hover:text-zinc-900">
            Portfolio
          </Link>
          <ConnectButton />
        </nav>
...
export const Footer = () => (
  <footer className="relative mt-0 bg-zinc-950 text-zinc-200">
    ...
    <div className="mx-auto max-w-7xl px-6 py-14">
      ...
      <div className="mt-10 pt-6 text-xs text-zinc-500">
