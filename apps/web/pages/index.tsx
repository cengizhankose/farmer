...
export default function Landing() {
  const whyItems = [
    { title: "Solution‑oriented development", subtitle: "Delivering pragmatic, resilient features for real users" },
    { title: "Market environment", subtitle: "Built with awareness of liquidity, risk, and opportunity" },
    { title: "Transparent payment", subtitle: "Clear fees and on‑chain paths — no hidden costs" },
    { title: "Sales", subtitle: "Value‑first communication with measurable outcomes" },
  ];

  return (
    <div className="relative">
      <div style={{ background: "linear-gradient(to right, #e9e9e9, #1c1d1f)" }}>
      <ScrollOrchestrator
        ...
        scenes={[
          ...
          },
          {
            ...
            theme: "dark",
            bg: "linear-gradient(to right, #0a0a0a, #e9e9e9)",
            render: (p) => (
