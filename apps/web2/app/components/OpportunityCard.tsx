...
export function OpportunityCard({ opportunity }: OpportunityCardProps) {
  ...
  const getRiskColor = (risk: string) => {
    switch (risk) {
      ...
      case 'med': return '#f59e0b'; // amber-500
  ...
  return (
    ...
    onMouseLeave={(e) => {
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', marginBottom: '1rem' }}>
        <div>
          <p style={{ margin: 0, fontSize: '0.875rem', color: '#6b7280' }}>TVL</p>
      ...
      {/* Tokens */}
      <div style={{ marginBottom: '1rem' }}>
        <p style={{ margin: '0 0 0.25rem 0', fontSize: '0.875rem', color: '#6b7280' }}>Tokens</p>
      ...
      {opportunity.rewardToken && (
        <div style={{ marginBottom: '1rem' }}>
          <p style={{ margin: '0 0 0.25rem 0', fontSize: '0.875rem', color: '#6b7280' }}>Rewards</p>
          <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
      ...
      {/* Additional Metadata */}
      {(opportunity.volume24h || opportunity.exposure || opportunity.ilRisk) && (
        <div style={{
          padding: '0.75rem',
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(80px, 1fr))', gap: '0.5rem' }}>
            {opportunity.volume24h && (
              <div>
                <p style={{ margin: 0, fontSize: '0.75rem', color: '#6b7280' }}>24h Volume</p>
            ...
            {opportunity.exposure && (
              <div>
                <p style={{ margin: 0, fontSize: '0.75rem', color: '#6b7280' }}>Exposure</p>
                <p style={{ margin: 0, fontSize: '0.875rem', fontWeight: '500', color: '#374151', textTransform: 'capitalize' }}>
                  {opportunity.exposure}
                </p>
              </div>
            )}
            {opportunity.ilRisk && (
              <div>
                <p style={{ margin: 0, fontSize: '0.75rem', color: '#6b7280' }}>IL Risk</p>
                <p style={{ margin: 0, fontSize: '0.875rem', fontWeight: '500', color: '#374151', textTransform: 'capitalize' }}>
                  {opportunity.ilRisk}
                </p>
              </div>
